...
// Usage: Convert from Bitmap to ByteArray *** NEW ***
...
// Usage: Crop to ByteArray *** NEW ***
fun ImageView.cropToByteArray(width: Int, height: Int): ByteArray {
    return drawable?.toBitmapOrNull()?.crop(width, height)?.toByteArray() ?: ByteArray(0)
}
